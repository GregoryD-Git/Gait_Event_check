...
png_filename = 'Force-MarkerVelocity_Comparison.png'
...
# Replace 'output.pdf' with your desired PDF filename
png_filename = 'Force-Events_Comparison.png'
...
FootOff_dict = {
    ...
    'Subject':      [C3Ddict['C3D File Name']] * len(gfOff_diff)
    }
...
FootStr_dict = {
    ...
    'Subject':      [C3Ddict['C3D File Name']] * len(gfStr_diff)
    }
